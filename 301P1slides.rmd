...
We calculated RMSE for our prediction model and to do so we converted the response variable, trained a random forest model, and made predictions to ultimately calculate the RMSE.

The formula to calculate RMSE(Root Mean Squared Error) is:
