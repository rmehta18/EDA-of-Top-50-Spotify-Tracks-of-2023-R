...
## Loading in our data and cleaning it up
So the following code was used to load in our data and to split genres and create a separate row for each genre while preserving song and artist information

We also had to edit the csv file a bit by choosing the primary genre attached to each song as many had multiple genres attached to them
